...
<h2>  Comentários </h2>
    ...
    <form action="" method="post" name="form_comentario" id="form_comentario" >
        <input type="text" name="nome_comentario" placeholder="Digite seu nome: " class="campo"/>
        <input type="text" name="comentario" placeholder="Digitie seu comentário:" class="campo"size="50px"/>
