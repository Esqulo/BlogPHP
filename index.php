...
<!DOCTYPE HTML>                                                
    ...
    <div id="boavinda">
       <?php if ($_SESSION["sexo_usuario"]== 0){ 
												...
												echo  '<div class="h6">'.$_SESSION["nome_pessoa"].'  | </div>' ?> 
   </div>
...
<?php
  ...
  $postagens_001 = mysqli_query($conexao, "SELECT * 
                                         FROM tb_postagens 
                                         ORDER BY id_post DESC;") or die(mysql_error());
  ...
  while($postagens_002 = mysqli_fetch_object($postagens_001)){
	...
	$imagem_post = $postagens_002 -> imagem_post;
	$_SESSION["id_imagem"]++;
...
?> 
    ...
    <a href= "Post.php?id_post=<?php echo base64_encode($id_post); ?>"><img id="fotos" src="<?php echo $imagem_post;?>"></a>
    <article id="noticia">
